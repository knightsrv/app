...
var finish = -1 * ((windowWidth - jQuery('#scene_1').width()) / 2 + 1060);
...
jQuery(window).load(function () {
    ...
    setTimeout(function () {
        jQuery('#scene_1 #items div:nth-child(1) img').css({
            'transform': 'initial'
        });
    }, 600);
    setTimeout(function () {
        jQuery('#scene_1 #items div:nth-child(2) img').css({
            'transform': 'initial'
        });
    }, 1200);
    setTimeout(function () {
        jQuery('#scene_1 #items div:nth-child(3) img').css({
            'transform': 'initial'
        });
    }, 900);
    setTimeout(function () {
        jQuery('#scene_1 #items div:nth-child(4) img').css({
            'transform': 'initial'
        });
    }, 1200);
    setTimeout(function () {
        jQuery('#scene_1 #items div:nth-child(5) img').css({
            'transform': 'initial'
        });
    }, 1000);
    setTimeout(function () {
        jQuery('.headline a').css({
            'opacity': '1'
        });
    }, 1500);
...
function skills_show(vis) {
    ...
    jQuery('.widget_skills').each(function () {
        if (!jQuery(this).hasClass('vis')) {
            if ((jQuery(this).offset().top + 300) <= total) {
                jQuery(this).addClass(vis);
                var x = jQuery(this);
                setTimeout(function () {
                    Widgets(x);
